  ...
  return (
    <div className="wrapper m-auto h-screen  md:w-24 bg-blue-400  ">
                      ...
                      <ul className={ "md:flex md:flex-col  justify-center align-middle "}>
                          ...
                          <li  className="m-3 flex justify-center align-middle"><button onClick={()=>{/*setEditOn(!EditOn);setMode("Update");setDeleteOn(false)*/}} ><Image className='opacity-40' src={"/img/updateGroup.png"} alt="Menu image"  width={40} height={40} /></button></li>
